...
export function KieBalanceCard() {
  ...
  return (
    <div
      className={`rounded-2xl border border-brand-border bg-brand-surface p-5 transition-all duration-200 hover:border-brand-primary/30 hover:shadow-[0_0_30px_rgba(255,214,10,0.1)] ${getBalanceBg(credits)}`}
    >
      <div className="flex items-center justify-between gap-4">
        <div
